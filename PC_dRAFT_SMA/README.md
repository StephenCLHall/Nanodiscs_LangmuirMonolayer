This diectory contains all data, analysis and plotting scripts to reproduce the analysis of NR data corresponding to the interaction of dRAFT-SMA with DMPC Langmuir monolayers.  
...
`Fit_PC_Polymer.mat` | A RasCAL project file containing experimental and fitting parameters.
