...
% Calculation of Area Per Molecules
    Tail_VF = 1-VF_Polymer_Tails;
    
    Lipid_APM_After = (Vol_DM_tails_LC/Tail_Thickness_Final)*(Tail_VF);
...
% Volume Fraction (Component 1)
    AllLayers.Volume_Fraction_1(1:iterations,2) = Tail_VF;
    AllLayers.Volume_Fraction_1(1:iterations,3) = HG_Vol_Frac_After;
    
% Volume Fraction (Component 2)
% Note: This is any additional component that is NOT solvent
    AllLayers.Volume_Fraction_2(1:iterations,2) = VF_Polymer_Tails;
    AllLayers.Volume_Fraction_2(1:iterations,3) = VF_Polymer_Heads; 
...
%Enter layer names for layers whose components will be summed here
    Polymer_Containing_Layers = {'Tails', 'Heads'};
...
%Make this more seamless!
    Layers = {'Air', 'Tails', 'Heads', 'Polymer', 'Solvent'};
...
%% Choose colours for each component to be plotted
    ...
    Components_To_Plot = {'Air', 'Tails', 'Heads', 'Polymer', 'Solvent'};

    Colours = [black; ibm_orange; lightgreen; gold; ibm_blue];
