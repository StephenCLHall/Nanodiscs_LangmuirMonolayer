function SLDplot_Paper(bayesfile, ShowXAxisLabels, ShowYAxisLabels)
%{
...
Data can be plotted as with or without axis labels
    ...
    Input arguments can be defined either in the script body, or from
    command line
%}
...
% Comment bayesfile if intending to define from command line
    ...
    bayesfile = 'PC_PG_Bayes_Model_12';
...
%% Setup the loop to add plots   
    ...
    for n = 1:length(order)
        ...
        col = colours(i,:);
        addPlot(thisSLD, minCurve, maxCurve, col, offset);
        
    end
end

function addPlot(thisSLD, minCurve, maxCurve, col, offset)
%{
