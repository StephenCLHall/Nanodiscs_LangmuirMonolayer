function [output,sub_rough] = Area_Per_Molecule_Constrained(params,bulk_in,bulk_out,contrast)
%{
...
%% ROUGHNESS RESAMPLING (SLICE ROUGHNESS INTO MANY LAYERS OF ZERO ROUGHNESS)

%Change resamp to zero to NOT resample roughnesses, and just use the standard
%Gaussian roughness. Good to set to 0 when initially fitting data as it
